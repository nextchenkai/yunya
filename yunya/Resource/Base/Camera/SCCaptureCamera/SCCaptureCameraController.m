...
- (void)takePictureBtnPressed:(UIButton*)sender {
    ...
    [_captureManager takePicture:^(UIImage *stillImage) {
        ...
        //your code 0
        SCCameraNavigationController *nav = (SCCameraNavigationController*)weakSelf_SC.navigationController;
        if ([nav.cameraDelegate respondsToSelector:@selector(didTakePicture:image:)]) {
            [nav.cameraDelegate didTakePicture:nav image:stillImage];
        }
        //or your code 1
